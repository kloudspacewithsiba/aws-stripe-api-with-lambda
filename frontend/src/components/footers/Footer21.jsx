...
export default function Footer21() {
  return (
    <footer className="footer footer_type_1 border-top bg-white">
      <div className="footer-top container">
        <div className="block-newsletter mb-4">
          <h3 className="block__title text-uppercase fs-24 fw-semi-bold mb-2">
          ...
          >
            ...
            />
            <button
              className="btn btn-secondary fw-semi-bold fs-base border-1"
              type="submit"
            >
              JOIN
            </button>
